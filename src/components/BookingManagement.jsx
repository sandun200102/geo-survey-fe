            ...
            <div className="flex flex-col md:flex-row gap-4 flex-1">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full md:w-48 appearance-none bg-white"
                >
                  ...
                  {filteredBookings.map((booking) => (
                    <tr key={booking._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="font-medium text-gray-900">{booking.equipmentname}</div>
                        <div className="text-sm text-gray-500">ID: {booking.equipmentId}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
