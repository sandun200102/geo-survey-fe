                ...
                <tr key={user._id}>
                  ...
                  <td className="px-6 py-4 flex space-x-3">
                    <button
                      ...
                      className="bg-green-600/30 text-green-400 px-3 py-1 rounded hover:bg-green-600/40 flex items-center"
                    >
                    ...
                    <button
                      ...
                      className="bg-red-600/30 text-red-400 px-3 py-1 rounded hover:bg-red-600/40 flex items-center"
                    >
